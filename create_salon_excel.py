...
city_inputs = [
    ...
    ("Kuala Lumpur",      "kuala_lumpur.html",   "Malaysia",   "MY",  800, 3, 26,  90, 0.10, 3500, 33000, 20000, 6000,  3, 0.65, 0.75,   3.148,  101.686, 40, 1500, 200),
    ...
    ("Taipei",            "taipei.html",         "Taiwan",     "TW",  850, 3, 26, 104, 0.10, 3400, 55800, 20000, 6600,  3, 0.65, 0.75,  25.033,  121.565, 35, 1800, 200),
    ("Taichung",          "taichung.html",       "Taiwan",     "TW",  800, 3, 26, 110, 0.10, 3000, 46500, 18000, 5400,  3, 0.65, 0.75,  24.163,  120.647, 42, 1800, 200),
    ("Kaohsiung",         "kaohsiung.html",      "Taiwan",     "TW",  800, 3, 26, 120, 0.10, 2000, 37200, 17000, 3600,  3, 0.65, 0.75,  22.627,  120.302, 48, 1800, 200),
    ("Tainan",            "tainan.html",         "Taiwan",     "TW",  750, 3, 26, 100, 0.10, 1500, 34100, 16000, 2700,  3, 0.65, 0.75,  22.993,  120.202, 55, 1800, 200),
