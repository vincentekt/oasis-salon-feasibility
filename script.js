document.addEventListener('DOMContentLoaded', () => {
    ...
    const citiesDb = [
    {
        ...
        "cogs": "USD 16.00",
        "margin": "90%",
        "breakeven": "~74 customers",
        "daily_breakeven": "~2.8 customers/day",
        "tax": "20.0%",
        "pat_ratio": "40% (Post-Tax)",
        "payback": "23 Months",
        "underserved": "42%",
        "airport": "30 mins (BKK) / 35 mins (DMK)",
        "risk": "Hard water (TDS 300–500 ppm) RO filtration critical; high Thonglor rent premium",
        "complexity": {
            "total": 355,
    ...
    },
    {
        ...
        "underserved": "61%",
        "airport": "45 mins (SGN)",
        "risk": "Korean factory shift rotation cycles; product supply chain from HCMC",
        "complexity": {
            "total": 388,
    ...
    },
    {
        ...
        "cogs": "USD 24.00",
        "margin": "90%",
        "breakeven": "~79 customers",
        "daily_breakeven": "~3.0 customers/day",
        "tax": "30.0%",
        "pat_ratio": "34% (Post-Tax)",
        "payback": "20 Months",
        "underserved": "42%",
        "airport": "20 mins (BNE)",
    ...
    },
    {
        ...
        "underserved": "29%",
        "airport": "10 mins (DAD)",
        "risk": "Seasonal tourism slump (Nov–Feb monsoon); nomad base fluctuates",
        "complexity": {
            "total": 320,
    ...
    },
    {
        ...
        "cogs": "USD 5.50",
        "margin": "90%",
        "breakeven": "~87 customers",
        "daily_breakeven": "~3.3 customers/day",
        "tax": "20.0%",
        "pat_ratio": "40% (Post-Tax)",
        "payback": "17 Months",
        "underserved": "71%",
        "airport": "60 mins (SGN)",
        "risk": "Zero local competition but small total expat population; 60-min SGN logistics",
        "complexity": {
            "total": 440,
    ...
    },
    {
        ...
        "daily_breakeven": "~4.4 customers/day",
        "tax": "20.0%",
        "pat_ratio": "40% (Post-Tax)",
        "payback": "18 Months",
        "underserved": "55%",
    ...
    },
    {
        ...
        "cogs": "USD 9.50",
        "margin": "90%",
        "breakeven": "~90 customers",
        "daily_breakeven": "~3.5 customers/day",
        "tax": "20.0%",
        "pat_ratio": "40% (Post-Tax)",
        "payback": "21 Months",
        "underserved": "38%",
    ...
    },
    {
        ...
        "cogs": "USD 6.50",
        "margin": "90%",
        "breakeven": "~94 customers",
        "daily_breakeven": "~3.6 customers/day",
        "tax": "24.0%",
        "pat_ratio": "38% (Post-Tax)",
        "payback": "28 Months",
        "underserved": "52%",
        "airport": "30 mins (JHB) / 50 mins (SIN)",
        "risk": "RTS operational delays; Singapore cross-border demand tied to exchange rate sensitivity",
        "complexity": {
            "total": 315,
    ...
    },
    {
        ...
        "underserved": "52%",
        "airport": "45 mins (KUL)",
        "risk": "Bangsar clustering — KLCC/Ampang corridor gap vs. 4 competitors in Bangsar",
        "complexity": {
            "total": 375,
    ...
    },
    {
        ...
        "cogs": "USD 13.00",
        "margin": "90%",
        "breakeven": "~73 customers",
        "daily_breakeven": "~2.8 customers/day",
        "tax": "12.0%",
        "pat_ratio": "44% (Post-Tax)",
        "payback": "21 Months",
        "underserved": "25%",
        "airport": "10 mins (MFM)",
    ...
    },
    {
        ...
        "cogs": "USD 22.00",
        "margin": "90%",
        "breakeven": "~101 customers",
        "daily_breakeven": "~3.9 customers/day",
        "tax": "30.0%",
        "pat_ratio": "35% (Post-Tax)",
        "payback": "20 Months",
        "underserved": "0%",
        "airport": "28 mins (MEL)",
        "risk": "High AU labour + superannuation burden; Chapel St rent inflation and lease competition from F&B",
        "complexity": {
            "total": 329,
    ...
    },
    {
        ...
        "underserved": "11%",
        "airport": "35 mins (PEN)",
        "risk": "Georgetown heritage DA restrictions on fit-out; limited premium residential density vs. KL",
        "complexity": {
            "total": 305,
    ...
    },
    {
        ...
        "daily_breakeven": "~3.9 customers/day",
        "tax": "24.0%",
        "pat_ratio": "37% (Post-Tax)",
        "payback": "29 Months",
        "underserved": "35%",
        "airport": "15 mins (BKI)",
        "risk": "Small total expat base; East Malaysia logistics cost for premium product supply",
        "complexity": {
            "total": 425,
    ...
    },
    {
        ...
        "underserved": "22%",
        "airport": "20 mins (KCH)",
        "risk": "Shell/Petronas expat rotation cycles; East Malaysia freight costs for salon products",
        "complexity": {
            "total": 400,
    ...
    },
    {
        ...
        "underserved": "45%",
        "airport": "25 mins (SIN)",
        "risk": "Extremely high rent overheads; Holland V lease competition from F&B operators",
        "complexity": {
            "total": 280,
    ...
    },
    {
        ...
        "underserved": "38%",
        "airport": "22 mins (SYD)",
        "risk": "High AU labour costs (Award + 11.5% superannuation); inner-west DA heritage restrictions on fit-out",
        "complexity": {
            "total": 360,
    ...
    },
    {
        ...
        "cogs": "USD 12.00",
        "margin": "90%",
        "breakeven": "~58 customers",
        "daily_breakeven": "~2.2 customers/day",
        "tax": "20.0%",
        "pat_ratio": "39% (Post-Tax)",
        "payback": "26 Months",
        "underserved": "22%",
        "airport": "15 mins (KHH)",
    ...
    },
    {
        ...
        "risk": "TSMC Sinshih expat base still ramping — 2025-2027 growth dependency",
        "complexity": {
            "total": 355,
    ...
    },
    {
        ...
        "risk": "Intense local competition; 6–9 hr wait at top competitors creates booking model risk",
        "complexity": {
            "total": 405,
    ...
    },
    {
        ...
        "underserved": "12%",
        "airport": "15 mins (FUK)",
        "risk": "30% JP corporate tax + high fitout cost; intense TONI&GUY/saco japan competition in Tenjin/Daimyo",
        "complexity": {
            "total": 425,
    ...
    },
    {
        ...
        "underserved": "55%",
        "airport": "15 mins (OKA)",
        "risk": "Bilingual (English/Korean) stylist recruitment very difficult; 30% JP tax burden",
        "complexity": {
            "total": 480,
        ...
        "underserved": "35%",
        "airport": "30 mins (PUS)",
        "risk": "K-franchise dominance (Juno Hair 200+ outlets); Marine City appointment-only model requires strong pre-booking system",
        "complexity": {
            "total": 403,
    ...
    },
    {
        ...
        "cogs": "USD 16.00",
        "margin": "90%",
        "breakeven": "~111 customers",
        "daily_breakeven": "~4.3 customers/day",
        "tax": "9.0%",
        "pat_ratio": "45% (Post-Tax)",
        "payback": "18 Months",
        "underserved": "50%",
        "airport": "15 mins (DXB)",
